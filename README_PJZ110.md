...
The current milestone provides a tested **offline, fail-closed** analyzer/patcher for `PJZ110_16.0.10.501(CN01)`. It deliberately does not enable device flashing while the firmware's GBL/EFISP path is still unverified.
