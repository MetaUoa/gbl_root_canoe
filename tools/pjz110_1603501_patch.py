#!/usr/bin/env python3
"""OnePlus 13 (PJZ110 / SM8750) 16.0.3.501 LinuxLoader analyzer and fail-closed patcher.

This tool is intentionally version-scoped.  The only writable profile shipped in
this first revision is PJZ110_16.0.3.501(CN01).  Unknown images are analyzed but
never patched.
...
PROFILE_ID = "pjz110-16.0.3.501-cn01"
PROFILE_BUILD = "PJZ110_16.0.3.501(CN01)"
ABL_SHA256 = "320615838af3094f56e90613172d8bf0a3ed8a81a9b4ea9663b92142508478ca"
LINUXLOADER_SHA256 = "1873bdfd2654decba1ac50d2c0d1d3aa61423f11123f7301743be78da7f63333"
LINUXLOADER_SIZE = 0xC4000
...
DEVICE_STATE_UNL_ADRP = 0x4C38C
DEVICE_STATE_UNL_ADD = 0x4C390
DEVICE_STATE_LOCK_ADRP = 0x4C394
DEVICE_STATE_LOCK_ADD = 0x4C398
DEVICE_STATE_KEY_ADRP = 0x4C39C
DEVICE_STATE_KEY_ADD = 0x4C3A0
DEVICE_STATE_CMP = 0x4C3A8
DEVICE_STATE_CSEL = 0x4C3AC

VERIFIED_TABLE_BASE = 0xA3CB0
VERIFIED_GREEN_PTR = 0xA3CB8  # state 0
VERIFIED_ORANGE_PTR = 0xA3CC8  # state 1
GREEN_STRING = 0x87995
ORANGE_STRING = 0x84822

EXPECTED_DEVICE_WORDS = {
    DEVICE_STATE_UNL_ADRP: 0x90000229,
    DEVICE_STATE_UNL_ADD: 0x9119FD29,
    DEVICE_STATE_LOCK_ADRP: 0xB00001AA,
    DEVICE_STATE_LOCK_ADD: 0x9136BD4A,
    DEVICE_STATE_KEY_ADRP: 0x90000181,
    DEVICE_STATE_KEY_ADD: 0x9135FC21,
...
def analyze(path: Path) -> tuple[Analysis, bytes]:
    ...
    if extracted and input_hash == ABL_SHA256:
        notes.append("input matches the profiled PJZ110 16.0.3.501 ABL")
    elif extracted:
