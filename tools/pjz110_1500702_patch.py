#!/usr/bin/env python3
"""OnePlus 13 (PJZ110 / SM8750) 15.0.0.702 LinuxLoader analyzer and fail-closed patcher.

This tool is intentionally version-scoped.  The only writable profile shipped in
this first revision is PJZ110_15.0.0.702(CN01).  Unknown images are analyzed but
never patched.
...
PROFILE_ID = "pjz110-15.0.0.702-cn01"
PROFILE_BUILD = "PJZ110_15.0.0.702(CN01)"
ABL_SHA256 = "fa9a688137393b101d65b8833033d3ddbd9674abf546557e07d43bbe3ff6b6a2"
LINUXLOADER_SHA256 = "5401e5daeed7260066a6505a31f59470d07c57f27bc6871738866f713c03fed6"
LINUXLOADER_SIZE = 0xBE000
...
DEVICE_STATE_UNL_ADRP = 0x3BDFC
DEVICE_STATE_UNL_ADD = 0x3BE00
DEVICE_STATE_LOCK_ADRP = 0x3BE04
DEVICE_STATE_LOCK_ADD = 0x3BE08
DEVICE_STATE_KEY_ADRP = 0x3BE0C
DEVICE_STATE_KEY_ADD = 0x3BE10
DEVICE_STATE_CMP = 0x3BE18
DEVICE_STATE_CSEL = 0x3BE1C

VERIFIED_TABLE_BASE = 0x9B9A8
VERIFIED_GREEN_PTR = 0x9B9B0  # state 0
VERIFIED_ORANGE_PTR = 0x9B9C0  # state 1
GREEN_STRING = 0x825A2
ORANGE_STRING = 0x7F72B

EXPECTED_DEVICE_WORDS = {
    DEVICE_STATE_UNL_ADRP: 0xF0000269,
    DEVICE_STATE_UNL_ADD: 0x912FE529,
    DEVICE_STATE_LOCK_ADRP: 0xD000020A,
    DEVICE_STATE_LOCK_ADD: 0x91106D4A,
    DEVICE_STATE_KEY_ADRP: 0xB00001E1,
    DEVICE_STATE_KEY_ADD: 0x910D8C21,
...
def analyze(path: Path) -> tuple[Analysis, bytes]:
    ...
    if extracted and input_hash == ABL_SHA256:
        notes.append("input matches the profiled PJZ110 15.0.0.702 ABL")
    elif extracted:
